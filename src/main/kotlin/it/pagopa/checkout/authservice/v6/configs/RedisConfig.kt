package it.pagopa.checkout.authservice.v6.configs
...
import it.pagopa.checkout.authservice.v6.repositories.redis.OidcKeysRepository
...
import it.pagopa.checkout.authservice.v6.repositories.redis.bean.oidc.OidcKey
...
@Configuration("RedisConfigv6")
class RedisConfig {

    @Bean("authenticatedUserSessionRepositoryv6")
    ...
    @Bean("oidcAuthStateRepositoryv6")
