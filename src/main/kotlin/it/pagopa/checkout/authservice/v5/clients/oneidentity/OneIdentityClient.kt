package it.pagopa.checkout.authservice.v5.clients.oneidentity

import it.pagopa.checkout.authservice.v5.exception.AuthFailedException
import it.pagopa.checkout.authservice.v5.exception.OneIdentityConfigurationException
import it.pagopa.checkout.authservice.v5.exception.OneIdentityServerException
import it.pagopa.checkout.authservice.v5.repositories.redis.bean.oidc.AuthCode
import it.pagopa.checkout.authservice.v5.repositories.redis.bean.oidc.OidcNonce
...
class OneIdentityClient(
    ...
    @Autowired
    @Qualifier("oneIdentityWebClientv5")
