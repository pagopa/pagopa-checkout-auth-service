package it.pagopa.checkout.authservice.v9.configs
...
import it.pagopa.checkout.authservice.v9.repositories.redis.OidcKeysRepository
...
import it.pagopa.checkout.authservice.v9.repositories.redis.bean.oidc.OidcKey
...
@Configuration("RedisConfigv9")
class RedisConfig {

    @Bean("authenticatedUserSessionRepositoryv9")
    ...
    @Bean("oidcAuthStateRepositoryv9")
