...
import it.pagopa.checkout.authservice.v3.repositories.redis.OidcKeysRepository
...
import it.pagopa.checkout.authservice.v3.repositories.redis.bean.oidc.OidcKey
...
@Configuration("RedisConfigV3")
class RedisConfig {

    @Bean("authenticatedUserSessionRepositoryv3")
    ...
    @Bean("oidcAuthStateRepositoryv3")
