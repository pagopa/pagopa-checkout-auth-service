package it.pagopa.checkout.authservice.v4.configs
...
import it.pagopa.checkout.authservice.v4.repositories.redis.OidcKeysRepository
...
@Configuration("RedisConfigv4")
class RedisConfig {

    @Bean("authenticatedUserSessionRepositoryv4")
    ...
    @Bean("oidcAuthStateRepositoryv4")
