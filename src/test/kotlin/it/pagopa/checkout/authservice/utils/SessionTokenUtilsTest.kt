...
class SessionTokenUtilsTest {
    ...
    @Test
    fun `getBearerTokenFromRequestHeaders should extract token when valid bearer token is present`() {
        // Given
        ...
        // When
        val result = sessionTokenUtils.getBearerTokenFromRequestHeaders(request)
    ...
    @Test
    fun `getBearerTokenFromRequestHeaders should handle case-insensitive bearer prefix`() {
        // Given
        val token = "valid-token-123"
        val request =
            MockServerHttpRequest.get("/")
    ...
    @Test
    fun `getBearerTokenFromRequestHeaders should return error when authorization header is missing`() {
        // Given
    ...
    @Test
    fun `getBearerTokenFromRequestHeaders should return error when authorization header is empty`() {
        // Given
