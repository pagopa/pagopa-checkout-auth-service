package it.pagopa.checkout.authservice.v3.clients.oneidentity

import it.pagopa.checkout.authservice.v3.exception.AuthFailedException
import it.pagopa.checkout.authservice.v3.exception.OneIdentityConfigurationException
import it.pagopa.checkout.authservice.v3.exception.OneIdentityServerException
import it.pagopa.checkout.authservice.v3.repositories.redis.bean.oidc.AuthCode
import it.pagopa.checkout.authservice.v3.repositories.redis.bean.oidc.OidcNonce
...
class OneIdentityClient(
    ...
    @Autowired
    @Qualifier("oneIdentityWebClientv3")
