package it.pagopa.checkout.authservice.v1.exceptionhandler

import it.pagopa.checkout.authservice.v1.exception.ApiError
...
@RestControllerAdvice("ExceptionHandlerV1")
class ExceptionHandlerV1 {
