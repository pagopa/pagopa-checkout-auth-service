package it.pagopa.checkout.authservice.v7.configs
...
import it.pagopa.checkout.authservice.v7.repositories.redis.OidcKeysRepository
...
import it.pagopa.checkout.authservice.v7.repositories.redis.bean.oidc.OidcKey
...
@Configuration("RedisConfigv7")
class RedisConfig {

    @Bean("authenticatedUserSessionRepositoryv7")
    ...
    @Bean("oidcAuthStateRepositoryv7")
