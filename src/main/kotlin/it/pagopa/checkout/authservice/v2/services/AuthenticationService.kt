package it.pagopa.checkout.authservice.v2.services

import it.pagopa.checkout.authservice.v2.clients.oneidentity.OneIdentityClient
import it.pagopa.checkout.authservice.v2.exception.AuthFailedException
import it.pagopa.checkout.authservice.v2.exception.SessionValidationException
...
import it.pagopa.checkout.authservice.v2.repositories.redis.bean.auth.Name
import it.pagopa.checkout.authservice.v2.repositories.redis.bean.auth.UserFiscalCode
import it.pagopa.checkout.authservice.v2.repositories.redis.bean.auth.UserInfo
import it.pagopa.checkout.authservice.v2.repositories.redis.bean.oidc.AuthCode
import it.pagopa.checkout.authservice.v2.repositories.redis.bean.oidc.OidcAuthStateData
import it.pagopa.checkout.authservice.v2.repositories.redis.bean.oidc.OidcState
import it.pagopa.checkout.authservice.v2.utils.JwtUtils
import it.pagopa.checkout.authservice.v2.utils.SessionTokenUtils
import it.pagopa.generated.checkout.authservice.v2.model.LoginResponseDto
import it.pagopa.generated.checkout.authservice.v2.model.UserInfoResponseDto
import java.util.*
...
@Service("AuthenticationServiceV2")
