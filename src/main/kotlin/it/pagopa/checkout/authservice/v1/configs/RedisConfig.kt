package it.pagopa.checkout.authservice.v1.configs
...
import it.pagopa.checkout.authservice.v1.repositories.redis.bean.auth.AuthenticatedUserSession
...
@Configuration("redisConfigV1")
class RedisConfig {

    @Bean("authenticatedUserSessionRepositoryv1")
    ...
    @Bean("oidcAuthStateRepositoryv1")
