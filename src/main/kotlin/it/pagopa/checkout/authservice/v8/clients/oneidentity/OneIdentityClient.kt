package it.pagopa.checkout.authservice.v8.clients.oneidentity
...
import it.pagopa.checkout.authservice.v8.repositories.redis.bean.oidc.OidcNonce
...
class OneIdentityClient(
    ...
    @Autowired
    @Qualifier("oneIdentityWebClientv8")
