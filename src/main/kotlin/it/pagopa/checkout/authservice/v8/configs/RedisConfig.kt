package it.pagopa.checkout.authservice.v8.configs
...
@Configuration("RedisConfigv8")
class RedisConfig {

    @Bean("authenticatedUserSessionRepositoryv8")
    ...
    @Bean("oidcAuthStateRepositoryv8")
