package it.pagopa.checkout.authservice.v7.clients.oneidentity

import it.pagopa.checkout.authservice.v7.exception.AuthFailedException
import it.pagopa.checkout.authservice.v7.exception.OneIdentityConfigurationException
import it.pagopa.checkout.authservice.v7.exception.OneIdentityServerException
import it.pagopa.checkout.authservice.v7.repositories.redis.bean.oidc.AuthCode
import it.pagopa.checkout.authservice.v7.repositories.redis.bean.oidc.OidcNonce
...
class OneIdentityClient(
    ...
    @Autowired
    @Qualifier("oneIdentityWebClientv7")
