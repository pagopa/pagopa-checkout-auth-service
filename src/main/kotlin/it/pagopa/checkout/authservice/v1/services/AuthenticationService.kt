package it.pagopa.checkout.authservice.v1.services
...
import it.pagopa.checkout.authservice.v1.repositories.redis.bean.auth.UserInfo
...
@Service("AuthenticationServiceV1")
