package it.pagopa.checkout.authservice.v5.services

import it.pagopa.checkout.authservice.v5.clients.oneidentity.OneIdentityClient
import it.pagopa.checkout.authservice.v5.exception.AuthFailedException
import it.pagopa.checkout.authservice.v5.exception.SessionValidationException
import it.pagopa.checkout.authservice.v5.repositories.redis.AuthenticatedUserSessionRepository
import it.pagopa.checkout.authservice.v5.repositories.redis.OIDCAuthStateDataRepository
import it.pagopa.checkout.authservice.v5.repositories.redis.bean.auth.AuthenticatedUserSession
import it.pagopa.checkout.authservice.v5.repositories.redis.bean.auth.Name
import it.pagopa.checkout.authservice.v5.repositories.redis.bean.auth.UserFiscalCode
import it.pagopa.checkout.authservice.v5.repositories.redis.bean.auth.UserInfo
import it.pagopa.checkout.authservice.v5.repositories.redis.bean.oidc.AuthCode
import it.pagopa.checkout.authservice.v5.repositories.redis.bean.oidc.OidcAuthStateData
import it.pagopa.checkout.authservice.v5.repositories.redis.bean.oidc.OidcState
import it.pagopa.checkout.authservice.v5.utils.JwtUtils
import it.pagopa.checkout.authservice.v5.utils.SessionTokenUtils
import it.pagopa.generated.checkout.authservice.v5.model.LoginResponseDto
import it.pagopa.generated.checkout.authservice.v5.model.UserInfoResponseDto
import java.util.*
...
@Service("AuthenticationServicev5")
