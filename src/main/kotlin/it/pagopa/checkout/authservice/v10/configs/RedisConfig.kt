package it.pagopa.checkout.authservice.v10.configs
...
import it.pagopa.checkout.authservice.v10.repositories.redis.OidcKeysRepository
...
import it.pagopa.checkout.authservice.v10.repositories.redis.bean.oidc.OidcKey
...
@Configuration("RedisConfigv10")
class RedisConfig {

    @Bean("authenticatedUserSessionRepositoryv10")
    ...
    @Bean("oidcAuthStateRepositoryv10")
