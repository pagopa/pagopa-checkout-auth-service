package it.pagopa.checkout.authservice.v2.clients.oneidentity

import it.pagopa.checkout.authservice.v2.exception.AuthFailedException
import it.pagopa.checkout.authservice.v2.exception.OneIdentityConfigurationException
import it.pagopa.checkout.authservice.v2.exception.OneIdentityServerException
import it.pagopa.checkout.authservice.v2.repositories.redis.bean.oidc.AuthCode
import it.pagopa.checkout.authservice.v2.repositories.redis.bean.oidc.OidcNonce
...
class OneIdentityClient(
    ...
    @Autowired
    @Qualifier("oneIdentityWebClientv2")
