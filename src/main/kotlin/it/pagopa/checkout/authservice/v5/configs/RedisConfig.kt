package it.pagopa.checkout.authservice.v5.configs
...
import it.pagopa.checkout.authservice.v5.repositories.redis.OidcKeysRepository
...
import it.pagopa.checkout.authservice.v5.repositories.redis.bean.oidc.OidcKey
...
@Configuration("RedisConfigv5")
class RedisConfig {

    @Bean("authenticatedUserSessionRepositoryv5")
    ...
    @Bean("oidcAuthStateRepositoryv5")
