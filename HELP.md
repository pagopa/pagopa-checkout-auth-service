...
* The original package name 'it.pagopa.checkout.authservice.pagopa-checkout-auth-service' is invalid and this project uses 'it.pagopa.checkout.authservice.pagopa_checkout_authservice' instead.
...
```
$ docker run --rm pagopa-checkout-auth-service:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/pagopa-checkout-auth-service
```
